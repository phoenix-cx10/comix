...
function ContactForm() {
  ...
  return (
    <section className="bg-[#F7F4EA] py-16 px-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B95723] focus:border-transparent"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B95723] focus:border-transparent resize-none"
                  required
                ></textarea>
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#B95723] text-white py-3 px-6 rounded-lg hover:bg-[#A04A1F] transition-colors duration-300 font-semibold"
              >
                Send Message
              </button>
            </form>
