  ...
  return (
    <section className="p-6 bg-white min-h-screen">
      <div className="container mx-auto max-w-6xl">
        <h2 className="text-3xl font-bold text-center mb-2 text-gray-800">Shopping Cart</h2>
        ...
        {cart.length === 0 ? (
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6 h-fit sticky top-6">
              ...
              <button className="w-full bg-[#42625F] text-white py-3 rounded-lg hover:bg-[#36524F] transition-colors font-semibold mb-4">
                Proceed to Checkout
              </button>
              
              <Link 
                to="/products" 
                className="block text-center text-[#B95723] hover:text-[#A04A1F] transition-colors"
              >
                Continue Shopping
              </Link>
            </div>
